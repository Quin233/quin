 ...
 * 作    者：schrodinger
 * 版    本：1.0
 * 创建日期： 2019/1/4 9:29 AM
 * 描    述：
 * 修订历史：
 * ================================================
 */
class MusicMainAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        when(viewType){
            ITEM_TYPE.ITEM_TYPE_BANNER.ordinal->{ // Banner
                val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.include_music_banner, viewGroup, false)
                return BannerViewHolder(view)
            }
            ITEM_TYPE.ITEM_TYPE_MENU.ordinal->{ // 四个按钮
                val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.include_music_menu_item, viewGroup, false)
            ...
            ITEM_TYPE.ITEM_TYPE_TITLE.ordinal->{ // 标题
                val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.include_music_title, viewGroup, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is BannerViewHolder){
            ...
            holder.ivIcon.setImageResource((menuItem.data as MusicButtonItem).resource)
    ...
    fun getSpanSize(pos: Int): Int {
        ...
        when (viewType) {
            ITEM_TYPE_BANNER -> return 12
            ITEM_TYPE_TITLE -> return 12
            ITEM_TYPE_MENU -> return 3
            ITEM_TYPE_CONTENT -> return 4
            ITEM_TYPE_DIVIDER -> return 12
        }
        return 0
    }
    ...
    class TitleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var tvMusicTitle = itemView.findViewById(R.id.tv_music_title) as TextView
